...
int main()
{
    ...
    Shader equirectangularToCubemapShader("shader/2.2.2.cubemap.vs", "shader/2.2.2.equirectangular_to_cubemap.fs");
    Shader irradianceShader("shader/2.2.2.cubemap.vs", "shader/2.2.2.irradiance_convolution.fs");
    Shader prefilterShader("shader/2.2.2.cubemap.vs", "shader/2.2.2.prefilter.fs");
    Shader brdfShader("shader/2.2.2.brdf.vs", "shader/2.2.2.brdf.fs");
    Shader backgroundShader("shader/2.2.2.background.vs", "shader/2.2.2.background.fs");
