...
int main()
{
    ...
    // -------------------------
    Shader shader("shader/7.bloom.vs", "shader/7.bloom.fs");
    Shader shaderLight("shader/7.bloom.vs", "shader/7.light_box.fs");
    ...
    for (unsigned int i = 0; i < 2; i++)
    {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB32F, SCR_WIDTH, SCR_HEIGHT, 0, GL_RGBA, GL_FLOAT, NULL);
